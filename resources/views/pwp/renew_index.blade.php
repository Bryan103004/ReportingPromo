...
<div class="max-w-2xl mx-auto px-4 py-8">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Perbarui informasi rentang waktu pengerjaan untuk rekap data PWP.</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <form action="{{ route('pwp.renew', $pwp->id) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PUT')
