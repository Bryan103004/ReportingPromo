...
<div class="mx-auto max-w-4xl px-4 py-8">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="border-b border-gray-200 bg-gray-50 px-6 py-4">
            <h2 class="text-lg font-bold text-gray-800">Formulir Tambah PWP</h2>
            <p class="text-sm text-gray-500 mt-1">Silakan lengkapi data supplier dan detail PWP di bawah ini.</p>
        </div>

        <form action="{{route('pwp.store')}}" method="POST" class="p-6" enctype="multipart/form-data">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="text" name="no_raf" id="no_raf" class="w-full rounded-md border border-gray-300 px-4 py-2.5 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors" placeholder="Contoh: RAFPWP/NF/0001/08/2026" required>
                </div>
...
<script>
    ...
    function getNextNoRaf(){
        ...
        const url = '{{ url('/next-no-raf') }}?category=PWP' + (periode ? ('&periode=' + encodeURIComponent(periode)) : '');
    ...
    window.addEventListener('load', getNextNoRaf);
</script>
@endsection