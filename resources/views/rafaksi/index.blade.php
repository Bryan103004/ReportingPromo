...
<div class="mx-auto max-w-7xl px-4 py-8">
    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <a href="{{ route('rafaksi.create') }}" class="inline-flex items-center px-4 py-2 text-sm font-semibold text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors shadow-sm">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="overflow-x-auto">
            <table id="rafaksiTable" class="w-full text-left text-sm text-gray-600">
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse ($rafaksiGroups as $group)
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-center">
                                ...
                                <a href="{{ route('rafaksi.show_month', ['year' => $group->year, 'month' => $group->month]) }}" 
