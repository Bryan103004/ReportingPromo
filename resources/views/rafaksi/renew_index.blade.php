...
<div class="max-w-2xl mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <form action="{{ route('rafaksi.renew', $rafaksi->id) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-2">
                ...
                <div class="relative rounded-lg shadow-sm">
                    <input 
                        ...
                        name="periode_bulan" 
                        id="periode_bulan" 
                        value="{{ old('periode_bulan', isset($rafaksi->periode_bulan) ? \Carbon\Carbon::parse($rafaksi->periode_bulan)->format('Y-m-d') : '') }}"
