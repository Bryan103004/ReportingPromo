...
<div class="mx-auto max-w-4xl px-4 py-8">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="border-b border-gray-200 bg-gray-50 px-6 py-4">
            <h2 class="text-lg font-bold text-gray-800">Formulir Tambah Rafaksi</h2>
            <p class="text-sm text-gray-500 mt-1">Silakan lengkapi data supplier dan detail rafaksi di bawah ini.</p>
        </div>

        <form action="{{route('rafaksi.store')}}" method="POST" class="p-6" enctype="multipart/form-data">
            @csrf
