<x-list-container title="PWP EXPIRING   | Total Data: {{ $data->total() }}">
    ...
    @forelse($data as $row)
        <a href="{{ route('pwp.renew.index', ['id' => $row->id]) }}" class="block">
            <x-list-item
    ...
    @empty
        <div class="flex flex-col items-center justify-center py-10 text-gray-400">
            ...
            <span class="text-sm font-medium">Tidak ada data PWP bulan ini.</span>
        </div>
    @endforelse
