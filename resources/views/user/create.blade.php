            ...
            <div class="max-w-xl mx-auto p-4 bg-white rounded-xl shadow-sm border border-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                    ...
                    <label class="relative flex items-center p-3 rounded-lg border border-gray-200 cursor-pointer hover:bg-gray-50 transition-all select-none has-[:checked]:border-indigo-600 has-[:checked]:bg-indigo-50/50">
                        ...
                        <input type="checkbox" name="is_rafaksi_spv" value="1" class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
                    ...
                    <label class="relative flex items-center p-3 rounded-lg border border-gray-200 cursor-pointer hover:bg-gray-50 transition-all select-none has-[:checked]:border-indigo-600 has-[:checked]:bg-indigo-50/50">
                        ...
                        <input type="checkbox" name="is_jsm_spv" value="1" class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
                    ...
                    <label class="relative flex items-center p-3 rounded-lg border border-gray-200 cursor-pointer hover:bg-gray-50 transition-all select-none has-[:checked]:border-indigo-600 has-[:checked]:bg-indigo-50/50">
                        ...
                        <input type="checkbox" name="is_pwp_spv" value="1" class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
