...
@section('content')
    <div class="mx-auto max-w-4xl px-4 py-6 sm:px-6 lg:px-8">
        <div class="mb-5">
            <h1 class="text-2xl font-bold text-gray-900">Buat Master Role</h1>
            <p class="mt-1 text-sm text-gray-600">Tambahkan role baru dan pilih permission yang dibutuhkan.</p>
        </div>
        ...
        <form action="{{ route('role.store') }}" method="POST" class="space-y-5 rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}" required class="w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="Contoh: Supervisor">
            </div>

            <div>
                <p class="mb-2 block text-sm font-medium text-gray-700">Permissions</p>
