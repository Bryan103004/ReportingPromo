        ...
        <div class="mb-6">
            <form method="GET" action="{{ route('role.index') }}" class="flex gap-2">
                <div class="flex-1 relative">
                    <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari nama role..." class="w-full rounded-md border border-gray-300 px-4 py-2.5 text-sm focus:border-blue-500 focus:ring-blue-500 pl-10">
                ...
                <a href="{{ route('role.index') }}" class="rounded-md border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-100 transition-colors">Reset</a>
            </form>
        </div>
