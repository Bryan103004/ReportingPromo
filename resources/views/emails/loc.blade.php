...
<body>
    <div class="email-container">
        ...
        <div class="content">
            <h2 style="font-size: 18px; color: #111827;">Peringatan Masa Berlaku LOC</h2>
            <p>Halo <strong>{{ $user->name }}</strong>,</p>
            <p>Berikut adalah daftar LOC yang telah memasuki periode pengurusan renewal berdasarkan setting reminder:</p>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <!-- Kolom 1: Toko -->
                        <td>{{ $loc->tokos->pluck('nama_toko')->implode(', ') ?: '-' }}</td>
                        
                        <!-- Kolom 2: Nomor RAF -->
                        <td style="font-family: monospace;">{{ $loc->no_raf }}</td>
                        
                        <!-- Kolom 3: Periode Berakhir -->
                        <td style="color: #dc2626; font-weight: bold;">
                            {{ Carbon::parse($loc->periode_akhir)->format('d/m/Y') }}
                        </td>
                        
                        <!-- Kolom 4: Aksi -->
                        <td>
                            <a href="{{ route('loc.renew.index', ['id' => $loc->id]) }}" style="color: #4f46e5; text-decoration: underline; font-weight: bold;">
                                Lihat Detail
                            </a>
                        </td>
                    </tr>
