...
<div class="mx-auto max-w-7xl px-4 py-8">
    ...
    <div class="flex ms-auto m-4 gap-2">
        ...
        <a href="{{ route('jsm.print', array_merge(['year' => $year, 'month' => $month], request()->only(['category_id', 'toko_id']))) }}" class="bg-red-600 text-white px-4 py-2 rounded-lg font-semibold hover:bg-blue-700 transition">
            Print
        </a>
    </div>
