...
class LocController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $locGroups = $query->groupByRaw('YEAR(periode_bulan), MONTH(periode_bulan)') 
        ...
        return view('loc.index', compact('locGroups', 'suppliers', 'tokos', 'categories'));
    }
    ...
    public function exportExcel(Request $request)
    {
        ...
        return Excel::download(new DetailLocReport($year, $month, $stores, $categoryId, $tokoId), $fileName);
    }
