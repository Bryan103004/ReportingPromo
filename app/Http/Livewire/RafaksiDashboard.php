...
class RafaksiDashboard extends Component
{
    ...
    {
        // A Livewire-aware view (wire:click links) — NOT the shared vendor.pagination.tailwind
        // view used by plain server-rendered pages, which uses <a href> full-page navigation
        // and would blow away this component's in-memory $tokoId/$filterByPt state on every click.
        return 'vendor.pagination.livewire-tailwind';
    }

    public function render()
    {
        $query = DB::table('rafaksis as r')
