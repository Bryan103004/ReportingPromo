...
class DetailPwpReport implements FromView, ShouldAutoSize, WithStyles, WithStrictNullComparison, WithColumnFormatting
{
    protected $year;
    protected $month;
    protected $stores;
    ...
    public function view(): View
    {
        ...
        if ($this->year && $this->month) {
            ...
            $data = Pwp::with(['tokos','categories'])
